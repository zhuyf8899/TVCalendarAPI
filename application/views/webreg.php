<div class="container">
  ...
  <form class="form-signin" action="/TVCalendarAPI/index.php/UI/index" method="GET" onsubmit="return checkform();">
    ...
    <label for="inputEmail" class="sr-only">用户昵称</label>
    ...
    <div>
          <label>
            <input type="checkbox" value="agree" id="checkAgree" checked="checked"> 我已知晓并同意 <abbr title="建设中，当前如非开发人员请勿注册">用户协定</abbr>.
          </label>
        </div>
