 <!-- Main component for a primary marketing message or call to action -->
      ...
      <div class="jumbotron">
        ...
        <p>本平台基于开源协议发布，同时提供基于iOS系统和Android系统的移动客户端（正在开发），<a href="">点击下载</a></p>
        <p>更多问题请参阅<a href="/TVCalendarAPI/index.php/UI/QandA">常见问题</a>,我们强烈建议您在使用前或者有什么问题查看这个网页找到答案。</p>
        <p>
        <?php
        ...
        <h4>更新通知：</h4>
        <p>
          (2016.7.23)是不是发现现在不登陆也可以使用浏览剧集等功能啦？我们最近升级了验证策略，如有问题请及时联系管理员~
        </p>
      </div>
